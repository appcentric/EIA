create or replace
PACKAGE BODY ARP_LOCKBOX_HOOK AS
/*$Header: ARRLBHKB.pls 120.7.12010000.99999 2009/03/20 17:36:59 aghoraka ship $*/
--
/*----------------------------------------------------------------------------
...
BEGIN
  ...
  -- Call to Nucor (NYS) Custom Lockbox Extension - Pre-validtion - Start
  -- Added by Vivek Srinivasan 8/13/2013
  XXNUC_AR_LOCKBOX_HOOK_PKG.nys_lb_reseq_overflw_seq (out_errorbuf => out_errorbuf
                                                     ,out_errorcode => out_errorcode
                                                     ,in_trans_req_id =>  in_trans_req_id
                                                     ,out_insert_records => out_insert_records);
  -- Call to Nucor Custom Lockbox Extension - Pre-validtion - End
