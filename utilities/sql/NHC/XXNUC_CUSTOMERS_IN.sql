DROP TABLE EBS_INTF.XXNUC_CUSTOMERS_IN CASCADE CONSTRAINTS;

CREATE TABLE EBS_INTF.XXNUC_CUSTOMERS_IN
(
  CUSTOMER_IN_KEY                 NUMBER,
...
CREATE UNIQUE INDEX EBS_INTF.XXNUC_CUSTOMERS_IN_U1 ON EBS_INTF.XXNUC_CUSTOMERS_IN
(CUSTOMER_IN_KEY)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON EBS_INTF.XXNUC_CUSTOMERS_IN TO NUCOR_DEV;
