DROP TABLE XXNUC_AR_INVOICE_BATCHES;

CREATE TABLE XXNUC_AR_INVOICE_BATCHES
(
  BATCH_KEY                    NUMBER,
...
DROP SEQUENCE XXNUC_AR_INVOICE_BATCHES_S ;

CREATE SEQUENCE  XXNUC_AR_INVOICE_BATCHES_S  START WITH 1000 INCREMENT BY 1;

CREATE UNIQUE INDEX XXNUC_AR_INVOICE_BATCHES_N1 ON XXNUC_AR_INVOICE_BATCHES ( BATCH_KEY);


DROP TABLE XXNUC_AR_TRANS_LINES CASCADE CONSTRAINTS;

CREATE TABLE XXNUC_AR_TRANS_LINES
(
  AR_LINE_KEY                    NUMBER,
  ...
  INTERFACE_LINE_ATTRIBUTE9       VARCHAR2(150 BYTE), -- Added  INTERFACE_LINE_ATTRIBUTE9 to INTERFACE_LINE_ATTRIBUTE15
  ...
  LINK_TO_LINE_ATTRIBUTE8         VARCHAR2(150 BYTE),-- Added  LINK_TO_LINE_ATTRIBUTE8 to LINK_TO_LINE_ATTRIBUTE15
  ...
  REFERENCE_LINE_ATTRIBUTE6       VARCHAR2(150 BYTE), -- Added  REFERENCE_LINE_ATTRIBUTE6 to REFERENCE_LINE_ATTRIBUTE15
...
DROP SEQUENCE XXNUC_AR_TRANS_LINES_S;

CREATE SEQUENCE  XXNUC_AR_TRANS_LINES_S  START WITH 1000 INCREMENT BY 1;

CREATE UNIQUE INDEX XXNUC_AR_TRANS_LINES_U1 ON XXNUC_AR_TRANS_LINES ( AR_LINE_KEY);


DROP TABLE XXNUC_AR_TRANS_DISTS CASCADE CONSTRAINTS;

CREATE TABLE XXNUC_AR_TRANS_DISTS
(
  AR_DIST_KEY                NUMBER,
  AR_LINE_KEY                NUMBER,
  BATCH_NAME                 VARCHAR2(40 BYTE),
...
DROP SEQUENCE XXNUC_AR_TRANS_DISTS_S;

CREATE SEQUENCE  XXNUC_AR_TRANS_DISTS_S  START WITH 1000 INCREMENT BY 1;

CREATE UNIQUE INDEX XXNUC_AR_TRANS_DISTS_U1 ON XXNUC_AR_TRANS_DISTS ( AR_DIST_KEY);

CREATE UNIQUE INDEX XXNUC_AR_TRANS_DISTS_N1 ON XXNUC_AR_TRANS_DISTS ( AR_LINE_KEY);
