...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table XXNUC_SUPPLIERS_IN
--------------------------------------------------------
DROP TABLE XXNUC_SUPPLIERS_IN CASCADE CONSTRAINTS;

  CREATE TABLE "XXNUC"."XXNUC_SUPPLIERS_IN" 
...
--------------------------------------------------------
--  DDL for Index XXNXX_SUPPLIERS_IN_U1
--------------------------------------------------------

  CREATE UNIQUE INDEX "XXNUC"."XXNXX_SUPPLIERS_IN_U1" ON "XXNUC"."XXNUC_SUPPLIERS_IN" ("SUPPLIER_IN_KEY");
  --------------------------------------------------------
--  SEQUENCE XXNXX_SUPPLIERS_IN_U1
--------------------------------------------------------
