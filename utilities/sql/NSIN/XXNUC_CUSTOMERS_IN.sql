...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table XXNUC_CUSTOMERS_IN
--------------------------------------------------------
DROP TABLE XXNUC_CUSTOMERS_IN CASCADE CONSTRAINTS;

  CREATE TABLE "XXNUC"."XXNUC_CUSTOMERS_IN" 
   (	"CUSTOMER_IN_KEY" NUMBER, 
	...
	"DATE_OF_HIGHEST_BAL" VARCHAR2(20 BYTE), 
	"CREDIT_LEAD" VARCHAR2(100 BYTE), 
	"AMOUNT_OF_FIRST_SALE" VARCHAR2(100 BYTE), 
	"DATE_OF_FIRST_SALE" VARCHAR2(20 BYTE), 
...
--------------------------------------------------------
--  DDL for Index XXNUC_CUSTOMERS_IN_U1
--------------------------------------------------------

  CREATE UNIQUE INDEX "XXNUC"."XXNUC_CUSTOMERS_IN_U1" ON "XXNUC"."XXNUC_CUSTOMERS_IN" ("CUSTOMER_IN_KEY");
--------------------------------------------------------
--  SEQUENCE XXNUC_CUSTOMERS_IN_U1
--------------------------------------------------------
