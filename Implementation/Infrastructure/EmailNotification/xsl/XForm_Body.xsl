  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        <oracle-xsl-mapper:schema location="../../xsd/MYORACLE_SOATOOLKIT_EMAIL_OBJ.xsd"/>
        <oracle-xsl-mapper:rootElement name="SOATOOLKIT_EMAIL_OBJ" namespace="http://xmlns.oracle.com/xdb/MYORACLE"/>
      ...
      <Email:HTMLString>
        <html>
          <body>
            ...
            <p>
              <span style="font-family:arial,helvetica,sans-serif;">The process "<xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_NAME"/>"
                                                                                                                                                                   has
                                                                                                                                                                   completed.</span>
            </p>
            <p>
            ...
            <table border="1" cellpadding="0" cellspacing="0" height="60" width="950">
              <tbody>
                <tr>
                  ...
                  <td>
                    <strong>
                      <span style="font-family:arial,helvetica,sans-serif;">Request Id</span>
                    </strong>
                  </td>
                  <td>
                    <strong>
                ...
                <tr>
                  <td>
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/LOG_ID"/>
                    </span>
                  </td>
                  <td>
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/REQUEST_ID"/>
                    </span>
                  </td>
                  <td>
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_NAME"/>
                    </span>
                  </td>
                  <td>
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/SOURCE_SYSTEM"/>
                    </span>
                  </td>
                  <td>
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TARGET_SYSTEM"/>
                    </span>
                  </td>
                  <td>
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <xsl:value-of select="concat(substring-before(/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/CREATED_TIME,&quot;T&quot;),' ',substring-before(substring-after(/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/CREATED_TIME,&quot;T&quot;),&quot;.&quot;))"/>
                    </span>
                  </td>
                  <td>
                    <xsl:choose>
                      <xsl:when test="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_STATUS = 'SUCCESS'">
                        <span style="font-family:arial,helvetica,sans-serif;color:#00ff00;">
                          <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_STATUS"/>
                        </span>
                      </xsl:when>
                      <xsl:when test="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_STATUS = 'Error'">
                        <span style="font-family:arial,helvetica,sans-serif;color:#ff0000;">
                          <xsl:value-of select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_STATUS"/>
                        </span>
                      </xsl:when>
                      <xsl:when test="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_LOG/TRANSACTION_STATUS = 'Warning'">
            ...
            <xsl:choose>
              <xsl:when test="count(/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_STEP_LOG/AUDIT_STEP_LOG_ITEM/STEP_LOG_ID[text()]) > 0">
                <p>
                ...
                <table border="1" cellpadding="0" cellspacing="0" height="60" width="950">
                  <tbody>
                    ...
                    <xsl:for-each select="/MYORACLE:SOATOOLKIT_EMAIL_OBJ/AUDIT_STEP_LOG/AUDIT_STEP_LOG_ITEM">
            ...
            <p>
              <span style="font-family:arial,helvetica,sans-serif;">Please do not hesitate to contact the Service Desk
                                                                    ...
                                                                    regarding the transaction.<br/>Please quote Request
                                                                                                   Id or alternately Log
                                                                                                   Id.<br/><br/><strong>Thank
                                                                                                                        You,<br/>Service
