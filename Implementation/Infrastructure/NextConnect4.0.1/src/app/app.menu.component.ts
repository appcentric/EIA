    ...
    ngOnInit() {
        ...
        this.model = [
            {label: 'Home', icon: 'home', routerLink: ['/home']},
            {
                ...
                items: [
                    {label: 'Schedule', icon: 'date_range', routerLink: ['/soaschedule']},
                    {label: 'Environments', icon: 'assignment', routerLink: ['/soaenvironments']}
                ]
            },
            {
                label: 'Shop Floor Tools', icon: 'business', visible: this.sftVisible,
                items: [
