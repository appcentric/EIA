...
//DJJ Components
import { ConsumerMappingsComponent } from './entity-mappings/consumers/consumer-mappings';
import { ConsumerEntitiesComponent } from './entity-mappings/consumers/consumer-entities';
import { ConsumersComponent } from './entity-mappings/consumers/consumers';
import { FreightVendorMappingsComponent } from './entity-mappings/freight-vendors/freight-vendor-mappings';
import { FreightVendorEntitiesComponent } from  './entity-mappings/freight-vendors/freight-vendor-entities';
import { FreightVendorsComponent } from './entity-mappings/freight-vendors/freight-vendors';
import { ItemMappingsComponent } from './entity-mappings/items/item-mappings';
import { ItemEntitiesComponent } from './entity-mappings/items/item-entities';
import { ItemsComponent } from './entity-mappings/items/items';
import { ShipFromMappingsComponent } from './entity-mappings/ship-froms/ship-from-mappings';
import { ShipFromEntitiesComponent } from './entity-mappings/ship-froms/ship-from-entities';
import { ShipFromsComponent } from './entity-mappings/ship-froms/ship-froms';
import { ShipToMappingsComponent } from './entity-mappings/ship-tos/ship-to-mappings';
import { ShipToEntitiesComponent } from './entity-mappings/ship-tos/ship-to-entities';
import { ShipTosComponent } from './entity-mappings/ship-tos/ship-tos';
import { SupplierMappingsComponent } from './entity-mappings/suppliers/supplier-mappings';
import { SupplierEntitiesComponent } from './entity-mappings/suppliers/supplier-entities';
...
import { APInvoicesComponent } from './documents/invoices/ap-invoices';
import { APInvoicesByDateComponent } from './documents/invoices/ap-invoices-date';
import { PurchaseOrdersComponent } from './documents/purchase-orders/purchase-orders';
import { PurchaseOrdersByDateComponent } from './documents/purchase-orders/purchase-orders-date';
import { ShipmentsComponent } from './documents/shipments/shipments';
...
@NgModule({
    ...
    providers: [
        DJJAPIService, HomePageService, AuthService, AuthGuardService, 
    ],
