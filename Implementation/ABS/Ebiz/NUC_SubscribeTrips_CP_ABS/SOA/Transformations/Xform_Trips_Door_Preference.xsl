...
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/top/DB_Insert_Door_Preference"
                ...
                xmlns:ns9="http://xmlns.oracle.com/pcbpel/adapter/db/I028NewDesign/NUC_SubscribeTrips_CP_ABS/DB_Insert_Door_Preference">
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="WSDL">
        <oracle-xsl-mapper:schema location="WSDLs/DB_Insert_Door_Preference.wsdl"/>
        <oracle-xsl-mapper:rootElement name="DoorPreferenceCollection"
                                       namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/DB_Insert_Door_Preference"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [FRI JUN 24 03:10:05 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="GetSeqNextVal"/>
  <xsl:template match="/">
    <tns:DoorPreferenceCollection>
      <xsl:for-each select="/ns0:TripsAddRq/ns3:Trips/ns3:Trips/ns3:WshTripStps/ns3:Wsh_TripStps[(ns3:attribute8 != 'OSP Pick Up') and (ns3:stopType = 'Pick-up' or ns3:stopType = 'Picked-up')]">
        <tns:DoorPreference>
          <tns:operationId>
