...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU MAY 12 09:47:06 CDT 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:OperationCollection>
      <xsl:for-each select="/ns0:TripsAddRq/ns3:Trips/ns3:Trips/ns3:WshTripStps/ns3:Wsh_TripStps[ns3:stopType = 'Pick-up' or ns3:stopType = 'Picked-up']">
        <tns:Operation>
          ...
          <tns:operation>1400</tns:operation>
            ...
            <tns:AppointmentLogging>
              ...
              <xsl:choose>
                ...
                <xsl:when test='ns3:attribute8 = "Dock Out"'>
                  <tns:timestamp>
                    <xsl:value-of select="concat(substring(ns3:attribute5,1,4),'-',substring(ns3:attribute5,6,2),'-',substring(ns3:attribute5,9,2),'T',substring(ns3:attribute5,12,8))"/>
                  </tns:timestamp>
                </xsl:when>
              </xsl:choose>
          ...
          <xsl:choose>
            <xsl:when test="/ns0:TripsAddRq/ns3:Trips/ns3:Trips/ns3:attribute2 = 2100 or /ns0:TripsAddRq/ns3:Trips/ns3:Trips/ns3:attribute2 = 2200">
              <tns:operation>1400</tns:operation>
            </xsl:when>
          </xsl:choose>
        </tns:Operation>
