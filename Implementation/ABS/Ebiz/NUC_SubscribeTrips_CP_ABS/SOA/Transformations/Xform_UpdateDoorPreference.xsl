...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns9="http://xmlns.oracle.com/pcbpel/adapter/db/I028NewDesign/NUC_SubscribeTrips_CP_ABS/DB_Update_Door_Preference">
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU MAY 05 07:36:43 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:DoorPreferenceCollection>
      <xsl:for-each select="/ns0:parameters/ns0:item[ns0:value = 200 and ns0:msg = 0]">
        ...
        <xsl:for-each select="$ReceiveTrips_Consume_Message_InputVariable.body/ns1:TripsAddRq/ns3:Trips/ns3:Trips/ns3:WshTripStps/ns3:Wsh_TripStps[(ns3:attribute8 != 'OSP Pick Up') and (ns3:stopType = 'Pick-up' or ns3:stopType = 'Picked-up')]">
          <tns:DoorPreference>
            <tns:operationId>
            ...
            <tns:name>
              <xsl:value-of select="ns3:doorPreference"/>
            </tns:name>
          </tns:DoorPreference>
        </xsl:for-each>
      </xsl:for-each>
