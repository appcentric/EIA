...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [WED MAY 18 09:36:33 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:OperationCollection>
      <xsl:for-each select="/ns0:TripsAddRq/ns3:Trips/ns3:Trips/ns3:WshTripStps/ns3:Wsh_TripStps[ns3:stopType = 'Picked-up' or ns3:stopType = 'Pick-up']">
        <tns:Operation>
          <tns:operationId>
            <xsl:value-of select="oraext:sequence-next-val('OPERATION_SEQ','jdbc/omsi')"/>
          </tns:operationId>
          <tns:operation>2200</tns:operation>
