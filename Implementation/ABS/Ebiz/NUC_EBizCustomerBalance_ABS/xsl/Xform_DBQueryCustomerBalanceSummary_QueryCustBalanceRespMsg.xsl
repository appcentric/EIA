...
<xsl:stylesheet version="1.0" xmlns:xp20="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.Xpath20" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/" xmlns:eia="http://xmlns.eia.com/extensions/1.0" xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ns3="http://xmlns.eia.com/AO/EBiz/O2C/CustomerAO/1.0" xmlns:top="http://xmlns.oracle.com/pcbpel/adapter/db/top/DB_QueryCustomerBalanceSummary" xmlns:ns7="http://xmlns.eia.com/AO/EBiz/common/WhoAO/1.0" xmlns:bpm="http://xmlns.oracle.com/bpmn20/extensions" xmlns:ns10="http://xmlns.oracle.com/pcbpel/adapter/db/Nucor/NUC_EBizCustomerBalance_ABS/DB_QueryCustomerTransactions" xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/NucorSOA/NUC_EBizCustomerBalance_ABS/DB_QueryCustomerBalanceSummary" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:plt="http://schemas.xmlsoap.org/ws/2003/05/partner-link/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:utl="http://www.oracle.com/XSL/Transform/java/com.eia.soa.util.Configuration" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:ora="http://schemas.oracle.com/xpath/extension" xmlns:socket="http://www.oracle.com/XSL/Transform/java/oracle.tip.adapter.socket.ProtocolTranslator" xmlns:core="http://xmlns.eia.com/EO/Common/1.0" xmlns:ns1="http://xmlns.eia.com/AO/EBiz/common/OperationResultAO/1.0" xmlns:ns5="http://xmlns.eia.com/AO/EBiz/P2P/OrganizationAO/1.0" xmlns:mhdr="http://www.oracle.com/XSL/Transform/java/oracle.tip.mediator.service.common.functions.MediatorExtnFunction" xmlns:oraext="http://www.oracle.com/XSL/Transform/java/oracle.tip.pc.services.functions.ExtFunc" xmlns:ns0="http://xmlns.eia.com/ABS/EBiz/O2C/CustomerBalanceABS/1.0" xmlns:custbalam="http://xmlns.eia.com/AO/EBiz/O2C/CustomerBalanceAM/1.0" xmlns:dvm="http://www.oracle.com/XSL/Transform/java/oracle.tip.dvm.LookupValue" xmlns:hwf="http://xmlns.oracle.com/bpel/workflow/xpath" xmlns:ns4="http://xmlns.eia.com/AO/EBiz/common/AppsContextAO/1.0" xmlns:med="http://schemas.oracle.com/mediator/xpath" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ids="http://xmlns.oracle.com/bpel/services/IdentityService/xpath" xmlns:xdk="http://schemas.oracle.com/bpel/extension/xpath/function/xdk" xmlns:xref="http://www.oracle.com/XSL/Transform/java/oracle.tip.xref.xpath.XRefXPathFunctions" xmlns:ns2="http://xmlns.eia.com/AO/EBiz/O2C/CustomerBalanceAO/1.0" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns6="http://xmlns.eia.com/AO/EBiz/common/CommonAO/1.0" xmlns:ns9="http://xmlns.oracle.com/pcbpel/adapter/db/Nucor/NUC_EBizCustomerBalance_ABS/DB_QueryCustomerAging" xmlns:db="http://xmlns.oracle.com/pcbpel/adapter/db/DB_QueryCustomerAging" xmlns:ns8="http://xmlns.oracle.com/pcbpel/adapter/db/DB_QueryCustomerTransactions" xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap" exclude-result-prefixes="xsi xsl top ns10 tns plt wsdl xsd ns9 db ns8 ns3 ns7 soap12 soap mime core ns1 ns5 ns0 custbalam ns4 ns2 ns6 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap" xmlns:oracle-xsl-mapper="http://www.oracle.com/xsl/mapper/schemas">
    ...
    <custbalam:queryListOfCustomersBalanceResponseMessage>
      <custbalam:ListOfCustomersBalanceSummary>
        <ns2:Customer>
          <ns2:CustomerInfo>
            <ns3:Identifier>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:custAccountId"/>
            </ns3:Identifier>
            <ns3:CustomerName>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:accountName"/>
            </ns3:CustomerName>
            <ns3:CustomerNumber>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:accountNumber"/>
            </ns3:CustomerNumber>
            <ns3:ObjectVersionNumber>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:objectVersionNumber"/>
            </ns3:ObjectVersionNumber>
            <ns3:OrgName>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:hzParties/top:partyName"/>
            </ns3:OrgName>
          ...
          <ns2:CustomerBalanceSummary>
            <ns2:CustAccountId>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:custAccountId"/>
            </ns2:CustAccountId>
            <ns2:Currency>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:currency"/>
            </ns2:Currency>
            <ns2:BestCurrentReceivables>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:bestCurrentReceivables"/>
            </ns2:BestCurrentReceivables>
            <ns2:TotalDsoDaysCredit>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:totalDsoDaysCredit"/>
            </ns2:TotalDsoDaysCredit>
            <ns2:OpenInvoicesValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opInvoicesValue"/>
            </ns2:OpenInvoicesValue>
            <ns2:OpenInvoicesCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opInvoicesCount"/>
            </ns2:OpenInvoicesCount>
            <ns2:OpenCreditMemosCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opCreditMemosCount"/>
            </ns2:OpenCreditMemosCount>
            <ns2:OpenCreditMemosValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opCreditMemosValue"/>
            </ns2:OpenCreditMemosValue>
            <ns2:OpenDebitMemosCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opDebitMemosCount"/>
            </ns2:OpenDebitMemosCount>
            <ns2:OpenDebitMemosValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opDebitMemosValue"/>
            </ns2:OpenDebitMemosValue>
            <ns2:OpenDepositsValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opDepositsValue"/>
            </ns2:OpenDepositsValue>
            <ns2:OpenDepositsCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opDepositsCount"/>
            </ns2:OpenDepositsCount>
            <ns2:OpenBillsReceivablesValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opBillsReceivablesValue"/>
            </ns2:OpenBillsReceivablesValue>
            <ns2:OpenBillsReceivablesCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opBillsReceivablesCount"/>
            </ns2:OpenBillsReceivablesCount>
            <ns2:OpenChargebackValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opChargebackValue"/>
            </ns2:OpenChargebackValue>
            <ns2:OpenChargebackCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:opChargebackCount"/>
            </ns2:OpenChargebackCount>
            <ns2:UnresolvedCashValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:unresolvedCashValue"/>
            </ns2:UnresolvedCashValue>
            <ns2:UnresolvedCashCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:unresolvedCashCount"/>
            </ns2:UnresolvedCashCount>
            <ns2:ReceiptsAtRiskValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:receiptsAtRiskValue"/>
            </ns2:ReceiptsAtRiskValue>
            <ns2:InvAmtInDispute>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:invAmtInDispute"/>
            </ns2:InvAmtInDispute>
            <ns2:DisputedInvCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:disputedInvCount"/>
            </ns2:DisputedInvCount>
            <ns2:PendingAdjValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:pendingAdjValue"/>
            </ns2:PendingAdjValue>
            <ns2:LastDunningDate>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:lastDunningDate"/>
            </ns2:LastDunningDate>
            <ns2:DunningCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:dunningCount"/>
            </ns2:DunningCount>
            <ns2:PastDueInvValue>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:pastDueInvValue"/>
            </ns2:PastDueInvValue>
            <ns2:PastDueInvInstCount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:pastDueInvInstCount"/>
            </ns2:PastDueInvInstCount>
            <ns2:LastPaymentAmount>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:lastPaymentAmount"/>
            </ns2:LastPaymentAmount>
            <ns2:LastPaymentDate>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:lastPaymentDate"/>
            </ns2:LastPaymentDate>
            <ns2:LastPaymentNumber>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummVCollection/top:XxnucCustBalSummV/top:lastPaymentNumber"/>
            </ns2:LastPaymentNumber>
            <!--ns2:bucket_0>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket0"/>
            </ns2:bucket_0>
            <ns2:bucket_1_30>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket1_30"/>
            </ns2:bucket_1_30>
            <ns2:bucket_31_60>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket31_60"/>
            </ns2:bucket_31_60>
            <ns2:bucket_61_90>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket61_90"/>
            </ns2:bucket_61_90>
            <ns2:bucket_91_180>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket91_180"/>
            </ns2:bucket_91_180>
            <ns2:bucket_181_360>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket181_360"/>
            </ns2:bucket_181_360>
            <ns2:bucket_361_plus>
              <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:xxnucCustBalSummV/top:bucket361_Plus"/>
            </ns2:bucket_361_plus-->
          </ns2:CustomerBalanceSummary>
          <ns2:ListOfCustomerSites>
            <xsl:for-each select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:hzCustAcctSitesAllCollection/top:HzCustAcctSitesAll">
              <ns2:CutomerSite>
                <ns2:CustomerSite>
                  <ns3:Identifier>
                    <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:hzCustAcctSitesAllCollection/top:HzCustAcctSitesAll/top:custAcctSiteId"/>
                  </ns3:Identifier>
                  <ns3:SiteNumber>
                ...
                <ns2:CustomerSiteBalanceSummary>
                  <ns2:CustAccountId>
                    <xsl:value-of select="top:xxnucCustSiteBalSummVCollection/top:XxnucCustSiteBalSummV/top:custAccountId"/>
                  </ns2:CustAccountId>
                  <ns2:CustAcctSiteId>
                    <xsl:value-of select="top:custAcctSiteId"/>
                  </ns2:CustAcctSiteId>
                  <ns2:OrgId>
                    <xsl:value-of select="top:xxnucCustSiteBalSummVCollection/top:XxnucCustSiteBalSummV/top:orgId"/>
                  </ns2:OrgId>
                  <ns2:Currency>
                  ...
                  <!--ns2:bucket_0>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket0"/>
                  </ns2:bucket_0>
                  <ns2:bucket_1_30>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket1_30"/>
                  </ns2:bucket_1_30>
                  <ns2:bucket_31_60>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket31_60"/>
                  </ns2:bucket_31_60>
                  <ns2:bucket_61_90>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket61_90"/>
                  </ns2:bucket_61_90>
                  <ns2:bucket_91_180>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket91_180"/>
                  </ns2:bucket_91_180>
                  <ns2:bucket_181_360>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket181_360"/>
                  </ns2:bucket_181_360>
                  <ns2:bucket_361_plus>
                    <xsl:value-of select="top:xxnucCustSiteBalSummV/top:bucket361_Plus"/>
                  </ns2:bucket_361_plus-->
                </ns2:CustomerSiteBalanceSummary>
              </ns2:CutomerSite>
            </xsl:for-each>
          ...
          <ns2:ListOfCustomerAging>
            <xsl:for-each select="$QueryCustomerAging_RespMsg.DB_QueryCustomerAgingOutputCollection/db:DB_QueryCustomerAgingOutputCollection/db:DB_QueryCustomerAgingOutput">
              <ns2:CustomerAging>
                <ns2:CustAcctId>
                  <xsl:value-of select="/top:HzCustAccountsAllCollection/top:HzCustAccountsAll/top:hzCustAcctSitesAllCollection/top:HzCustAcctSitesAll/top:xxnucCustSiteBalSummV/top:custAccountId"/>
                </ns2:CustAcctId>
                <ns2:BucketLineId>
