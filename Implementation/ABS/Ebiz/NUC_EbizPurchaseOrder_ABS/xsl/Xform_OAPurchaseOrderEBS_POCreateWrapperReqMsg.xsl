    ...
    <db:InputParameters>
      ...
      <db:P_BATCH_ID>
        <xsl:attribute name="xsi:nil">
          <xsl:value-of select="/top:PoHeadersInterfaceCollection/top:PoHeadersInterface/top:batchId/@xsi:nil"/>
        </xsl:attribute>
        <xsl:value-of select="/top:PoHeadersInterfaceCollection/top:PoHeadersInterface/top:batchId"/>
      </db:P_BATCH_ID>
      <db:P_BUYER_ID>
      ...
      <db:P_DOCUMENT_SUBTYPE>
        <xsl:text disable-output-escaping="no"></xsl:text>
      </db:P_DOCUMENT_SUBTYPE>
      <db:P_CREATE_ITEMS>
        <xsl:text disable-output-escaping="no">N</xsl:text>
      </db:P_CREATE_ITEMS>
      <db:P_CREATE_SOURCING_RULES_FLAG>
        <xsl:text disable-output-escaping="no"></xsl:text>
      </db:P_CREATE_SOURCING_RULES_FLAG>
      <db:P_REL_GEN_METHOD>
        <xsl:text disable-output-escaping="no"></xsl:text>
      ...
      <db:P_ORG_ID_PARAM>
        <xsl:attribute name="xsi:nil">
          <xsl:value-of select="/top:PoHeadersInterfaceCollection/top:PoHeadersInterface/top:orgId/@xsi:nil"/>
        </xsl:attribute>
        <xsl:value-of select="/top:PoHeadersInterfaceCollection/top:PoHeadersInterface/top:orgId"/>
      </db:P_ORG_ID_PARAM>
      <db:P_GA_FLAG>
        <xsl:text disable-output-escaping="no"></xsl:text>
      </db:P_GA_FLAG>
