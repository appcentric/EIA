...
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                ...
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/apps/WI_Application/NUC_EbizPurchaseOrder_ABS/OA_CancelPurchaseOrderEBS"
                ...
                xmlns:db="http://xmlns.oracle.com/pcbpel/adapter/db/sp/OA_CancelPurchaseOrderEBS"
                ...
                exclude-result-prefixes="xsi xsl plt tns wsdl db xsd ns0 ns2 poam ns4 ns6 soap12 soap mime core ns1 ns3 ns5 ns10 ns7 ns8 ns9 bpws xp20 eia bpel bpm utl ora socket mhdr oraext dvm hwf med ids xdk xref ldap"
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="WSDL">
        ...
        <oracle-xsl-mapper:rootElement name="OutputParameters"
                                       namespace="http://xmlns.oracle.com/pcbpel/adapter/db/sp/OA_CancelPurchaseOrderEBS"/>
      </oracle-xsl-mapper:source>
    </oracle-xsl-mapper:mapSources>
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="WSDL">
        <oracle-xsl-mapper:schema location="oramds:/apps/EIAMetadata/ABS/EBiz/V1.0/P2P/PurchaseOrderABS.wsdl"/>
        <oracle-xsl-mapper:rootElement name="CancelPurchaseOrderLineResponseMessage"
  ...
  <xsl:template match="/">
    <poam:CancelPurchaseOrderLineResponseMessage>
      <ns14:HeaderRs>
        <ns14:RequestDetails>
