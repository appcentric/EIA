...
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                ...
                exclude-result-prefixes="xsi xsl ns1 ns2 ns3 ns6 soap12 soap mime wsdl ns10 core ns0 tns ns4 ns5 porecpam xsd ns11 ns7 ns8 ns9 bpws xp20 eia bpel bpm utl ora socket mhdr oraext dvm hwf med ids xdk xref ldap"
  ...
  <xsl:template match="/">
    <core:Fault>
      ...
      <core:CorrectiveAction>
        <xsl:value-of select='utl:getServiceProperty("NUC_EBizPOReceipt_ABS","ERROR_CORRECTION_RECOMMENDATION")'/>
      </core:CorrectiveAction>
