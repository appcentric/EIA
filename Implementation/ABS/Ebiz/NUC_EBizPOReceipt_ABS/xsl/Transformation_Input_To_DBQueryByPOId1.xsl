...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [MON FEB 15 07:17:58 CST 2016].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:PoHeadersAll>
      <xsl:if test="/ns0:QueryReceiptRequestMessage/ns0:Receipt/ns6:ListOfBasicReceiptLines/ns6:ReceiptLine[1]/ns6:BasicPurchaseOrder/ns17:PurchaseOrderNumber">
        <tns:segment1>
          <xsl:value-of select="/ns0:QueryReceiptRequestMessage/ns0:Receipt/ns6:ListOfBasicReceiptLines/ns6:ReceiptLine[1]/ns6:BasicPurchaseOrder/ns17:PurchaseOrderNumber"/>
        </tns:segment1>
      </xsl:if>
    </tns:PoHeadersAll>
  </xsl:template>
