...
<xsl:stylesheet version="1.0" xmlns:bpws="http://schemas.xmlsoap.org/ws/2003/03/business-process/"
                ...
                xmlns:ns13="http://xmlns.eia.com/AO/EBiz/common/CategoryAO/1.0"
                ...
                exclude-result-prefixes="xsi xsl tns ns1 ns2 ns3 ns6 ns8 soap12 soap mime wsdl ns13 core ns0 ns4 ns5 ns7 xsd ns9 ns10 ns11 ns12 paymentam bpws xp20 eia bpel bpm utl ora socket mhdr oraext dvm hwf med ids xdk xref ldap"
  ...
  <xsl:template match="/">
    <core:Fault>
      ...
      <core:CorrectiveAction>
        <xsl:text disable-output-escaping="no">Please enter Payment Identifier.</xsl:text>
      </core:CorrectiveAction>
