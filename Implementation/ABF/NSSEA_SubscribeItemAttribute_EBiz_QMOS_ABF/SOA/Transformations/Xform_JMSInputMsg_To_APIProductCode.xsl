...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
                ...
                xmlns:ns1="http://xmlns.oracle.com/pcbpel/adapter/jms/Manish/NSSEA_SubscribeItemAttribute_EBiz_QMOS_ABF/JMS_DEQ_NextGenDistributedTopic"
                ...
                xmlns:ns8="http://xmlns.oracle.com/pcbpel/adapter/db/Manish/NSSEA_SubscribeItemAttribute_EBiz_QMOS_ABF/DB_Insert_API_PRODUCT_CODE">
    ...
    <tns:ApiProductCodeCollection>
      <xsl:for-each select="/ns0:ItemAttributeAddRq/ns7:ItemAttributeDetails">
        <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_NSNE_ITEM_TYPE_MAP.dvm", "ITEMTYPE",ns7:UserItemType, "BILLET", "" ) = "Y" 
          ...
          <tns:ApiProductCode>
            <tns:id>
              <xsl:value-of select='oraext:sequence-next-val ("SEQ_API_PRODUCT_CODE_ID", "jdbc/NSSEAqmos" )'/>
            </tns:id>
            <tns:prodCode>
