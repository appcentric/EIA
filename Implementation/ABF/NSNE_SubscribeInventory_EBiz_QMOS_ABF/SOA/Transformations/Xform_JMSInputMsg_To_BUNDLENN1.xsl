      ...
      <ns0:ApiBundleTransExtCollection>
         <xsl:for-each select="/ns0:ApiBundleTransExtCollection/ns0:ApiBundleTransExt">
            <xsl:if test="ns0:transactionType !=&quot;DoNotUse&quot;">
               <xsl:if test="(ns0:tagNo != &quot;&quot;) and ((substring(ns0:tagNo, 1.0, 2.0) = &quot;NF&quot;) and (substring(ns0:tagNo, 5.0, 1.0) = &quot;1&quot;) or substring (ns0:tagNo, 1, 4 ) = &quot;1001&quot; or not (substring (ns0:tagNo, 1, 2 ) = &quot;NF&quot; and substring (ns0:tagNo, 5, 1 ) = &quot;2&quot; or substring (ns0:tagNo, 1, 4 ) = &quot;1002&quot; ))">
                  ...
                  <xsl:if test="(($g_TransactionType='RMA Receipt' and  contains($g_ResourceName,'RM1')) or $g_TransactionType!='RMA Receipt')">
