...
<xsl:stylesheet exclude-result-prefixes="xsi oracle-xsl-mapper xsl xsd ns0 tns xp20 oraxsl mhdr oraext dvm xref socket"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [WED JUL 27 06:40:10 CDT 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:ApiBilletTransExtCollection>
      <xsl:for-each select="/ns0:InventoryTransactionAddRq/ns8:InventoryTransactionDetails">
        <xsl:if test='ns8:ListOfInvTrx/ns8:TrxSourceName != concat (ns8:ListOfInvTrx/ns8:OrgCode, "_QMOS" )'>
          <xsl:variable name="lotValue" select="'null'"/>
          <xsl:for-each select="ns8:ListOfInvTrx/ns8:ListOfInvTrxDetails/ns8:InvTrxDetails">
            ...
            <xsl:variable name="varMillId">
              <xsl:choose>
                <xsl:when test="not(preceding-sibling::ns7:InvTrxDetails[1]/ns7:LotNumber = ns7:LotNumber)">
                  <tns:varMillIdLocal>
                    <xsl:value-of select="oraext:query-database (concat (&quot;select mill_id from (SELECT mill_id, 1 ord FROM v_cast_lot_mill WHERE bli_billet_batch ='&quot;,ns8:LotNumber,&quot;' and mill_id = 1 UNION ALL select 1 mill_id, 999 ord from dual where not exists(SELECT mill_id, 1 ord FROM v_cast_lot_mill WHERE bli_billet_batch ='&quot;,ns8:LotNumber,&quot;' and mill_id = 2)order by 2 asc) where rownum &lt; 2&quot;), false ( ), false ( ), &quot;jdbc/nsneqmos1_nonxa&quot; )"/>
                  </tns:varMillIdLocal>
                </xsl:when>
                <xsl:otherwise>
                  <tns:varMillIdLocal>
            ...
            <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_NSNE_ITEM_TYPE_MAP.dvm", "ITEMTYPE", ../../ns8:ItemType, "BILLET", "" ) = "Y" '>
              <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_TRANSACTION_TYPE_NAME_MAP.dvm", "TRANSACTION_TYPE_NAME", ../../ns8:TransactionType, "QMOS_BILLET", "" ) != ""'>
                ...
                <!-- <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/QMOS_NSNE_COMMON_STACK_MAP.dvm", "COMMON_STACK", ../../ns8:Locator, "FLAG", "" ) != ""  or $varMillId = "1" or dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_TRANSACTION_TYPE_NAME_MAP.dvm", "TRANSACTION_TYPE_NAME", ../../ns8:TransactionType, "QMOS_BILLET", "" ) = "PRO"'> -->
                <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/QMOS_NSNE_COMMON_STACK_MAP.dvm", "COMMON_STACK", ../../ns8:Locator, "FLAG", "" ) != "" 
                                             or $varMillId = "1"'>
                  <xsl:if test='((dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_TRANSACTION_TYPE_NAME_MAP.dvm", "TRANSACTION_TYPE_NAME", ../../ns8:TransactionType, "QMOS_BILLET", "" ) = "PRO" and (../../ns8:SubinventoryCode="TOLLING" and starts-with (../../ns8:Locator, "NN1.TOLL" )))
                    ...
                    <xsl:choose>
                      ...
                      <xsl:otherwise>
                        <tns:ApiBilletTransExt>
                          <tns:id>
                            <xsl:value-of select='oraext:sequence-next-val ("SEQ_API_BILLET_TRANS_EXT_ID", "jdbc/nsneqmos1" )'/>
                          </tns:id>
                          <tns:receiptDate>
                        ...
                        <tns:transactionType>SCP</tns:transactionType>
                          ...
                          <tns:apiBilletTransExtDtlsCollection>
                            <tns:ApiBilletTransExtDtls>
                              <tns:id>
                                <xsl:value-of select='oraext:sequence-next-val ("SEQ_BILLET_TRANS_EXT_DTLS_ID", "jdbc/nsneqmos1" )'/>
                              </tns:id>
                              <tns:billetId>
