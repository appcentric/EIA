...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SAT JUL 23 17:27:09 IST 2016].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:ApiProductCodeCollection>
      <xsl:for-each select="/ns0:ItemAttributeAddRq/ns9:ItemAttributeDetails">
        <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_NSNE_ITEM_TYPE_MAP.dvm", "ITEMTYPE",ns9:UserItemType, "BILLET", "" ) = "Y" and ns9:LotControlCode =2'>
          <tns:ApiProductCode>
            <!--
            <tns:id>
              <xsl:value-of select='oraext:sequence-next-val ("SEQ_API_PRODUCT_CODE_ID", $paramVar/ns1:parameters/ns1:item[(ns1:name = "JDBCName")]/ns1:value )'/>
            </tns:id>
            -->
            <tns:prodCode>
