...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [TUE JUL 26 22:31:11 IST 2016].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:ApiProductCodeCollection>
      <xsl:for-each select="/ns0:ItemAttributeAddRq/ns9:ItemAttributeDetails">
        <xsl:if test='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_NSNE_ITEM_TYPE_MAP.dvm", "ITEMTYPE",ns9:UserItemType, "BUNDLE", "" ) = "Y" and ns9:LotControlCode =2'>
          <tns:ApiProductCode>
            <tns:id>
              <xsl:value-of select='oraext:sequence-next-val ("SEQ_API_PRODUCT_CODE_ID", "jdbc/nsneqmos2" )'/>
            </tns:id>
            <tns:prodCode>
