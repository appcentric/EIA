...
=======
       ...
       <!--   <tns:carrierComment>
		  ...
		  <tns:carrierComment>
            <xsl:value-of select=substring ("/ns0:OutputParameters/ns0:P_SHIPMENT_LOG_ENTRY/ns0:P_SHIPMENT_LOG_ENTRY_ITEM[ns0:LOG_ENTRY_ID = $logEntryId]/ns0:CARRIER_COMMENTS",1,150)/>
          </tns:carrierComment>
          <tns:timeAwarded>
            <xsl:value-of select="substring-before(/ns0:OutputParameters/ns0:P_SHIPMENT_LOG_ENTRY/ns0:P_SHIPMENT_LOG_ENTRY_ITEM[ns0:LOG_ENTRY_ID = $logEntryId]/ns0:TIME_AWARDED,'T')"/>
          </tns:timeAwarded>
