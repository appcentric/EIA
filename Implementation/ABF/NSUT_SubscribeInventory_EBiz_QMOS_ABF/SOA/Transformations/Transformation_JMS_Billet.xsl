                      ...
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          <xsl:choose>
                            ...
                            <xsl:otherwise>
                              <tns:transactionType>
                                <xsl:value-of select='dvm:lookupValue ("oramds:/apps/EIAMetadata/CommonArtifacts/dvm/EBS_QMOS_TRANSACTION_TYPE_NAME_MAP.dvm", "TRANSACTION_TYPE_NAME", ../../ns7:TransactionType, "QMOS_BILLET", "" )'/>
                              </tns:transactionType>
                            </xsl:otherwise>
                          </xsl:choose>
                        </xsl:otherwise>
