...
<xsl:stylesheet version="1.0"
                ...
                xmlns:ns2="http://xmlns.oracle.com/pcbpel/adapter/db/Manish/NSUT_WorkOrder_EBizBatchJobs_ABF/DB_Select_API_WorkOrder_Status"
                xmlns:client="http://nucor.eia.com/WorkOrder_EBizBatchJobs"
                xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/"
                xmlns:ns3="http://xmlns.oracle.com/pcbpel/adapter/db/Manish/NSUT_WorkOrder_EBizBatchJobs_ABF/DB_Update_API_WorkOrder_Status">
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      ...
      <oracle-xsl-mapper:source type="WSDL">
        ...
        <oracle-xsl-mapper:param name="g_NVPair"/>
      </oracle-xsl-mapper:source>
    </oracle-xsl-mapper:mapSources>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU AUG 03 19:54:42 PDT 2017].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="g_NVPair"/>
  <xsl:template match="/">
    <tns:ApiWorkOrderStatusCollection>
      <xsl:for-each select="/ns0:DB_Select_API_WorkOrder_StatusOutputCollection/ns0:DB_Select_API_WorkOrder_StatusOutput">
        <tns:ApiWorkOrderStatus>
          ...
          <tns:lastError>
            <xsl:value-of select="$g_NVPair/ns1:parameters/ns1:item/ns1:value"/>
          </tns:lastError>
          <tns:processDate>
